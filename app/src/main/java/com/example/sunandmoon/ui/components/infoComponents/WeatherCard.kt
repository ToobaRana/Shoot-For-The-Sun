...
val weatherIcons : Map<String,List<Int>> = mapOf(
    ...
    "lightrain" to listOf(R.drawable.rain2, R.drawable.rain2),
    "lightrainandthunder" to listOf(R.drawable.rainthunder, R.drawable.rainthunder),
    "lightrainshowers" to listOf(R.drawable.rain2, R.drawable.rain2),
    ...
    "rain" to listOf(R.drawable.rain2, R.drawable.rain2),
    "rainandthunder" to listOf(R.drawable.rainthunder, R.drawable.rainthunder),
    "rainshowers" to listOf(R.drawable.rain2, R.drawable.rain2),
